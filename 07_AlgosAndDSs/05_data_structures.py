...
stack_of_employees.append("Mindaugas") # push()
...
# ... this stack is too permissive, it allows reading / removing / adding values from /to the middle
# ... classical stack should be much more restrictive - allow only certain operations
...
# print(stack_more_realistic.__stack)
